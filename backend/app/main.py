...
async def _execute_audit(body: AuditRequest) -> AuditResult:
    ...
    with warnings.catch_warnings():
        ...
        legacy_include_protocols = body.include_protocols
        legacy_include_account_auth = body.include_account_auth
        legacy_include_ecommerce = body.include_ecommerce
    ...
    try:
        ...
        scope = resolve_scope(
            ...
            legacy_include_protocols,
            legacy_include_account_auth,
            legacy_include_ecommerce,
        )
